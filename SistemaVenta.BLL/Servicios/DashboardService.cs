...
namespace SistemaVenta.BLL.Servicios
{
    public class DashboardService : IDashboardService
    {
        ...
        private async Task<int> TotalVentaUltimaSemana()
        {
            ...
            {
                var tablaVenta = retornarVentas(_ventaQuery, -7); //como es la ultima semana pasaremso -7
        ...
        private async Task<string> TotalIngresosUltimaSemana()
        {
            ...
            if(_ventaQuery.Count()> 0)
            {
                ...
                resultado = tablaVenta.Select(v => v.Total).Sum(v => v.Value);//EL VALUE DE NUESTREA COLUMAN TOTAL
            }
