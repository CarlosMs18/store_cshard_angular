...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C8238DADE");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FE633C396");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483610DC380");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A49060FF0E");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A35BA2FF1");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1323B4E0EFA");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76B5E435AC");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6CAA0B7F7");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56146DBC4BD4");
